...
function BoardMemberCard({ member }: { member: BoardMember }) {
  ...
  return (
    <div className="group">
      <div className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden border-4 border-gray-50 shadow-lg group-hover:border-brand-teal transition-colors relative">
        {imageError ? (
